...
public class DataSource {
    ...
    public Group[] fisioterapeutaTree = {
        new Group("Administração", new JInternalFrame[]{
            new Base(),
            new CadUsuario()
        })
    };
    public Group[] funcionarioTree = {
        new Group("Administração", new JInternalFrame[]{
            new Base(),
            new CadUsuario()
        }),
        new Group("testeFisio", new JInternalFrame[]{
            new Base(),
            new CadUsuario()
        }),
        new Group("Paciente", new JInternalFrame[]{
    ...
    public Group[] alunoTree = {
        new Group("Administração", new JInternalFrame[]{
            new Base(),
            new CadUsuario()
        }),
        new Group("TesteAluno", new JInternalFrame[]{
            new Base(),
            new CadUsuario()
        }),
        new Group("Paciente", new JInternalFrame[]{
